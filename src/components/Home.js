...
const Home = () => {
  ...
  const hcname = (e) => setCname(e.target.value);
  const hemail = (e) => setEmail(e.target.value);
  const hnumber = (e) => setNumber(e.target.value);
  const hmessage = (e) => setMessage(e.target.value);
  ...
  return (
    <div id='home'>
      <div className='md:mx-16 mx-0 py-14'>
        <section>
          <div className='text-white flex flex-col md:item-center justify-center items-center md:4xl w-full md:justify-between item-start p-10 md:p-20 md:flex md:flex-row'>
            ...
            <div className='md:w-3/5 md:pt-10'>
              <h1 className="text-3xl md:text-5xl font-semibold bg-clip-text text-transparent bg-shome tracking-tighter"
                data-aos="fade-up">
                Hello, I'm Bhavyaraj Bihola,
              </h1>

              <h1 className="text-2xl md:text-4xl font-semibold mt-3 tracking-tighter"
                data-aos="fade-up" data-aos-delay="200">
                Full-Stack Developer <i className="fa-solid ml-3 fa-code" style={{ color: "#B197FC" }}></i>
              </h1>

              <ul className="flex flex-row rounded mt-4" data-aos="zoom-in" data-aos-delay="300">
                <div className="bg-white rounded-xl flex text-3xl items-center justify-center w-12 h-12 mr-2 cursor-pointer hover:scale-110 transition-all duration-300">
                ...
                <div className="bg-white rounded-xl flex text-3xl items-center justify-center w-12 h-12 ml-2 cursor-pointer hover:scale-110 transition-all duration-300">
              ...
              <p className='text-md md:text-xl text-justify tracking-tight mt-4'
                ...
                Welcome to my creative corner! I’m a final year student with 3 months of hands-on experience in React development. I’m passionate about creating dynamic and responsive web applications. Currently, I’m seeking opportunities to apply my skills and contribute to exciting projects. Let’s connect!
              </p>
            ...
            <div className='w-64 h-64 rounded-full flex md:w-80 md:h-80 bg-white md:justify-center items-center lg:w-2/2 object-cover object-center mr-4'
