          ...
          >
            ...
            >
              ...
              <p className="text-md md:text-xl text-justify tracking-tight mt-4">
                I am Bhavyaraj Bihola, as a Frontend Developer I'm responsible
                for creating dynamic and visually engaging user interfaces. With
                expertise in HTML, CSS, and JavaScript, I leverage modern
                libraries and frameworks, such as React, to build seamless web
                experiences. My goal is to blend aesthetic design with
                functional performance to deliver top-quality web applications.
              </p>
            ...
            <ul className="flex flex-row rounded mt-4" data-aos="fade-in" data-aos-delay="300">
              ...
              <div className="flex flex-col md:flex-row items-center md:space-x-3 w-full">
                <button onClick={()=>setVisible(true)} className="button w-full md:w-auto mt-8 py-2 mb-5 px-4 text-sm md:text-lg md:py-3 md:px-6 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold hover:opacity-90 hover:scale-105 transition-transform duration-300 ease-in-out flex items-center justify-center">
                  Hire me
            ...
            >
              <div className="modal-inner p-8 bg-white rounded-lg shadow-lg max-w-lg mx-auto text-center relative z-50">
                <button onClick={() => setVisible(false)} className="close-modal absolute top-2 right-2 text-2xl">&times;</button>
